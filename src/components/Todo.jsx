  ...
  return (
    ...
    <div className="bg-gray-800 place-self-center rounded-4xl flex flex-col p-2 w-11/12 max-w-md min-h-[550px]">
      ...
      <div className="flex justify-between items-center gap-2 my-4 pl-5 pr-2">
        <input ref={inputRef} className="flex-1 text-white border bg-slate-800 border-gray-500 pl-4 p-0.5 rounded-full" placeholder="Add a new task..." />
        <button onClick={add} className="bg-gray-600 font-semibold text-white rounded-full ml-2 px-3 py-1 hover:bg-gray-700">Add +</button>
      </div>
